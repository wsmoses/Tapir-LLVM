...
void CilkSanitizerImpl::initializeCsanHooks() {
  ...
  CsanBeforeCallsite = checkCsiInterfaceFunction(
      M.getOrInsertFunction("__csan_before_call", IRB.getVoidTy(), IDType,
                            /*callee func_id*/ IDType, IRB.getInt8Ty(),
                            CallPropertyTy));
  CsanBeforeCallsite->addFnAttr(Attribute::InaccessibleMemOnly);
  CsanAfterCallsite = checkCsiInterfaceFunction(
      M.getOrInsertFunction("__csan_after_call", IRB.getVoidTy(), IDType,
                            IDType, IRB.getInt8Ty(), CallPropertyTy));
  ...
  GetSuppressionFlag = checkCsiInterfaceFunction(
      M.getOrInsertFunction("__csan_get_suppression_flag", RetType,
                            PointerType::get(SuppressionFlagTy, 0),
                            IDType, IRB.getInt8Ty()));
  GetSuppressionFlag->addParamAttr(0, Attribute::NoCapture);
  GetSuppressionFlag->addFnAttr(Attribute::InaccessibleMemOrArgMemOnly);

  SetSuppressionFlag = checkCsiInterfaceFunction(
      M.getOrInsertFunction("__csan_set_suppression_flag", RetType,
