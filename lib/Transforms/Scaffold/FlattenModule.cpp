...
struct FlattenModule : public ModulePass {
  ...
  FlattenModule() : ModulePass(ID) {
    initializeFlattenModulePass(*PassRegistry::getPassRegistry());
  }
...
static const char LS_NAME[] = "FlattenModule";
static const char ls_name[] = "Quantum Module Flattening Pass";
INITIALIZE_PASS_BEGIN(FlattenModule, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_DEPENDENCY(CallGraphWrapperPass)
INITIALIZE_PASS_END(FlattenModule, LS_NAME, ls_name, false, false)