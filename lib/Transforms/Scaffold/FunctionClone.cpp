...
struct FunctionClone : public ModulePass {
  ...
  FunctionClone() : ModulePass(ID) {
    initializeFunctionClonePass(*PassRegistry::getPassRegistry());
  }
...
static const char LS_NAME[] = "FunctionClone";
static const char ls_name[] = "Function Cloning Pass";
INITIALIZE_PASS_BEGIN(FunctionClone, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_DEPENDENCY(CallGraphWrapperPass)
INITIALIZE_PASS_END(FunctionClone, LS_NAME, ls_name, false, false)
