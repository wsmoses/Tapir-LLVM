...
struct GenQASM : public ModulePass {
  ...
  GenQASM() : ModulePass(ID) {
    initializeGenQASMPass(*PassRegistry::getPassRegistry());
  }
...
char GenQASM::ID = 0;
static const char LS_NAME[] = "gen-qasm";
static const char ls_name[] = "Generate QASM output code";
INITIALIZE_PASS_BEGIN(GenQASM, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_DEPENDENCY(CallGraphWrapperPass)
INITIALIZE_PASS_END(GenQASM, LS_NAME, ls_name, false, false)