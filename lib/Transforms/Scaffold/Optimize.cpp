...
struct Optimize : public ModulePass {
  ...
  Optimize() : ModulePass(ID) {
    initializeOptimizePass(*PassRegistry::getPassRegistry());
  }
...
char Optimize::ID = 0;
static const char LS_NAME[] = "Optimize";
static const char ls_name[] = "Optimize";
INITIALIZE_PASS_BEGIN(Optimize, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_DEPENDENCY(CallGraphWrapperPass)
INITIALIZE_PASS_END(Optimize, LS_NAME, ls_name, false, false)
