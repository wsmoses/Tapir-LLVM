...
struct ResourceCount : public ModulePass {
  ...
  ResourceCount() : ModulePass(ID) {
    initializeResourceCountPass(*PassRegistry::getPassRegistry());
  }
...
static const char LS_NAME[] = "ResourceCount";
static const char ls_name[] = "Resource Counter Pass";
INITIALIZE_PASS_BEGIN(ResourceCount, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_DEPENDENCY(CallGraphWrapperPass)
INITIALIZE_PASS_END(ResourceCount, LS_NAME, ls_name, false, false)