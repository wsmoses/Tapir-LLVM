...
public:
  ...
  FunctionReverse() : ModulePass(ID) {
    initializeFunctionReversePass(*PassRegistry::getPassRegistry());
  }
...
static const char LS_NAME[] = "FunctionReverse";
static const char ls_name[] = "Function Reverser";
INITIALIZE_PASS_BEGIN(FunctionReverse, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_END(FunctionReverse, LS_NAME, ls_name, false, false)
