...
struct Rotations : public ModulePass {
  ...
  Rotations() : ModulePass(ID) {
    initializeRotationsPass(*PassRegistry::getPassRegistry());
  }
...
char Rotations::ID = 0;
static const char LS_NAME[] = "Rotations";
static const char ls_name[] = "Rotation Decomposition";
INITIALIZE_PASS_BEGIN(Rotations, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_END(Rotations, LS_NAME, ls_name, false, false)
