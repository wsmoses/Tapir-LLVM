...
struct RTFreqEstHyb : public ModulePass {
  ...
  RTFreqEstHyb() : ModulePass(ID) {
    initializeRTFreqEstHybPass(*PassRegistry::getPassRegistry());
  }
...
static const char LS_NAME[] = "runtime-frequency-estimation-hybrid";
static const char ls_name[] = "Estimate frequency of modules at runtime";
INITIALIZE_PASS_BEGIN(RTFreqEstHyb, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_END(RTFreqEstHyb, LS_NAME, ls_name, false, false)
