...
struct RTResourceEst_Mem : public ModulePass {
  ...
  RTResourceEst_Mem() : ModulePass(ID) {
    initializeRTResourceEst_MemPass(*PassRegistry::getPassRegistry());
  }
...
static const char LS_NAME[] = "runtime-resource-estimation-memoized";
static const char ls_name[] = "Estimate qbits and qgates at runtime with memoization";
INITIALIZE_PASS_BEGIN(RTResourceEst_Mem, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_END(RTResourceEst_Mem, LS_NAME, ls_name, false, false)
