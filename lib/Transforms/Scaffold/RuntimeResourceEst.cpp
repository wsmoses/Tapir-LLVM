...
struct RTResourceEst : public ModulePass, public InstVisitor<RTResourceEst> {
  ...
  RTResourceEst() : ModulePass(ID) {
    initializeRTResourceEstPass(*PassRegistry::getPassRegistry());
  }
...
static const char LS_NAME[] = "runtime-resource-estimation";
static const char ls_name[] = "Estimate qbits and qgates at runtime";
INITIALIZE_PASS_BEGIN(RTResourceEst, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_END(RTResourceEst, LS_NAME, ls_name, false, false)
