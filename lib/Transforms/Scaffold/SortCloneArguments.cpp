...
struct SortCloneArguments : public ModulePass {
  ...
  SortCloneArguments() : ModulePass(ID) {
    initializeSortCloneArgumentsPass(*PassRegistry::getPassRegistry());
  }
...
static const char LS_NAME[] = "SortCloneArguments";
static const char ls_name[] = "Sorting Arguments of Cloned Function";
INITIALIZE_PASS_BEGIN(SortCloneArguments, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_END(SortCloneArguments, LS_NAME, ls_name, false, false)
