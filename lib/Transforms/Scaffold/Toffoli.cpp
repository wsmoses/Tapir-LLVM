...
struct ToffoliReplace : public ModulePass {
  ...
  ToffoliReplace() : ModulePass(ID) {
    initializeToffoliReplacePass(*PassRegistry::getPassRegistry());
  }
...
static const char LS_NAME[] = "ToffoliReplace";
static const char ls_name[] = "Toffoli Replacer";
INITIALIZE_PASS_BEGIN(ToffoliReplace, LS_NAME, ls_name, false, false)
INITIALIZE_PASS_END(ToffoliReplace, LS_NAME, ls_name, false, false)
