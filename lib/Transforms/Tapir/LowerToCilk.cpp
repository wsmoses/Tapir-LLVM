...
struct LowerTapirToTarget : public ModulePass {
  ...
  explicit LowerTapirToTarget(bool DisablePostOpts = false, bool Instrument = false)
      : ModulePass(ID), DisablePostOpts(DisablePostOpts),
        Instrument(Instrument) {
    tapirTarget = new CilkABI(Instrument);
...
INITIALIZE_PASS_BEGIN(LowerTapirToTarget, "tapir2cilk",
                      "Simple Lowering of Tapir to Cilk ABI", false, false)
INITIALIZE_PASS_DEPENDENCY(AssumptionCacheTracker)
INITIALIZE_PASS_DEPENDENCY(DominatorTreeWrapperPass)
INITIALIZE_PASS_END(LowerTapirToTarget, "tapir2cilk",
                    "Simple Lowering of Tapir to Cilk ABI", false, false)
...
//
namespace llvm {
ModulePass *createLowerTapirToTargetPass(bool DisablePostOpts, bool Instrument) {
  return new LowerTapirToTarget(DisablePostOpts, Instrument);
}
}
