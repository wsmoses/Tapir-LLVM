...
bool Loop2Cilk::isValidRewrite(Value *FromVal, Value *ToVal) {
...
///   bar((double)i);
///
void Loop2Cilk::HandleFloatingPointIV(Loop *L, PHINode *PN) {
...
void Loop2Cilk::RewriteNonIntegerIVs(Loop *L) {
...
Value *Loop2Cilk::ExpandSCEVIfNeeded(SCEVExpander &Rewriter, const SCEV *S,
...
///
/// This is mostly redundant with the regular Loop2Cilk activities that
/// happen later, except that it's more powerful in some cases, because it's
/// able to brute-force evaluate arbitrary instructions as long as they have
/// constant operands at the beginning of the loop.
void Loop2Cilk::RewriteLoopExitValues(Loop *L, SCEVExpander &Rewriter) {
...
bool Loop2Cilk::CanLoopBeDeleted(
...
namespace {
  class Loop2CilkVisitor : public IVVisitor {
    ScalarEvolution *SE;
    const TargetTransformInfo *TTI;
    PHINode *IVPhi;
  ...
  public:
    ...
    Loop2CilkVisitor(PHINode *IV, ScalarEvolution *SCEV,
                          const TargetTransformInfo *TTI,
                          const DominatorTree *DTree)
        : SE(SCEV), TTI(TTI), IVPhi(IV) {
      DT = DTree;
      WI.NarrowIV = IVPhi;
      if (/*ReduceLiveIVs*/ false )
...
///
void Loop2Cilk::SimplifyAndExtend(Loop *L,
  ...
  while (!LoopPhis.empty()) {
    ...
    do {
      ...
      Loop2CilkVisitor Visitor(CurrIV, SE, TTI, DT);
...
void Loop2Cilk::SinkUnusedInvariants(Loop *L) {
...
bool Loop2Cilk::runOnLoop(Loop *L, LPPassManager &LPM) {
  ...
  ReplaceInstWithInst( a, var );

  errs() << "<Starting cilk for fix>\n";
