...
; CHECK:   %index.next = add nuw nsw i64 %index, 2
...
; IND:   %index.next = add nuw nsw i64 %index, 2
...
; UNROLL:   %index.next = add nuw nsw i64 %index, 4
...
; IND: %index.next = add nuw nsw i32 %index, 2
...
; UNROLL: %index.next = add nuw nsw i32 %index, 4
...
; CHECK-NEXT:    %index.next = add nuw nsw i64 %index, 2
